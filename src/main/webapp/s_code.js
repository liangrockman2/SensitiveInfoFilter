...
var s_account="ubsexternhkebankingdev"
...
s.trackingServer="hps-dev:8080"

s.usePlugins = true;

function s_doPlugins(s) {
	//limits referrer to 255 characters
	console.log(document.referrer);
	if(document.referrer.length > 25) s.referrer = document.referrer.slice(0,25);
	console.log(s.referrer);
	s.eVar5="test for Jaman";
}
